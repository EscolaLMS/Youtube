...
class AuthenticateService extends AuthService implements AuthenticateServiceContract
{
	...
	public function authChannelWithCode($token): array
    {
		$authResponse = [];
	...
	protected function channelDetails(): ChannelListResponse
    {
		$params = ['mine' => true];
	...
	public function deleteEvent($youtubeEventId): bool
    {
        /**
         * [$service [instance of Google_Service_YouTube]]
         */
